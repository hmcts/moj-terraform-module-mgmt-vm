...
properties(
  [[$class: 'GithubProjectProperty', projectUrlStr: 'http://github.com/hmcts/moj-terraform-module-mgmt-vm/'],
...
@Library('Reform') _
        ...
        def secrets = [
            ...
            [$class: 'VaultSecret', path: 'secret/devops/public_key', secretValues:
                [[$class: 'VaultSecretValue', envVar: 'TF_VAR_ssh_key', vaultKey: 'value']]
            ]
